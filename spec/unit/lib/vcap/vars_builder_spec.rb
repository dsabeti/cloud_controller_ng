...
module VCAP::CloudController
  describe 'VarsBuilder' do
    describe 'vcap_application' do
      ...
      describe 'building has for a v2 app model' do
        ...
        context 'when memory_limit, disk_limit, file_descriptors are supplied' do
      ...
      describe 'building has for a v3 AppModel' do
        it 'builds hash with suppplied memory, disk_limit, file_descriptors and space' do
          expected_vcap_application =
            {
              'limits' => {
                'mem' => 5555,
                'disk' => 6666,
          ...
          vcap_application = vars_builder.vcap_application
          expect(vcap_application).to include( expected_vcap_application )
        end

        it 'defaults memory, disk_limit, file_descriptors to nil if no values are supplied' do
          expected_vcap_application =
            {
              'limits' => {
                'mem' => nil,
